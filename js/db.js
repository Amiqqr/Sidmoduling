...
const FALLBACK_PRODUCTS = [
    ...
    },
    {
      ...
      "badge": "Стиль",
      "sale": null,
      "description": "Бытовка в премиальном чёрном исполнении. Строгий дизайн с профлистом 0.45 мм чёрного цвета и окнами в цвет графит. Два двухкамерных окна (120x80 см), два замка на входной двери, линолеум и полный комплект защиты. Идеальное решение для тех, кто ценит стиль и комфорт на объекте.",
      "specifications": {
        "area": "14.4 м²",
        "length": "6 м",
        "width": "2.4 м",
    ...
    "specifications": {
      ...
      "badge": "Лучшая цена",
      "sale": null,
      "description": "Элитный модуль для жилья.",
      "specifications": {
        "area": "под заказ",
        "rooms": "под заказ",
        "bathroom": "под заказ",
